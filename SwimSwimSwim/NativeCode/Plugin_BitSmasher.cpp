...
namespace BitSmasher
{
    ...
    int InternalRegisterEffectDefinition(UnityAudioEffectDefinition& definition)
    {
        ...
        RegisterParameter(definition, "Mix amount", "", 0.0f, 1.0f, 0.5f, 1.0f, 1.0f, P_MIX, "Ratio");
        RegisterParameter(definition, "quantisation", "bands", 4.0, 6000.0f, 20.0f, 2.0f, 2000.0f, P_CRUSH, "");
        return numparams;
    }
